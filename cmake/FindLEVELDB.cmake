...
find_library(LEVELDB_LIBS NAMES leveldb PATHS /usr/lib $ENV{LEVELDB_ROOT}/lib $ENV{LEVELDB_ROOT} DOC "Path to leveldb library." )
...
if (LEVELDB_INCLUDE AND LEVELDB_LIBS)
  ...
  set(CMAKE_REQUIRED_LIBRARY ${LEVELDB_LIBS})
